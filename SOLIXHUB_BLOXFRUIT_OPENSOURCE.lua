...
-- loadstring(game:HttpGet('https://raw.githubusercontent.com/UKKung/crispy-parakeet/refs/heads/main/SOLIXHUB_BLOXFRUIT_OPENSOURCE.txt'))()
...
is_key_less = true  -- force skip key checker
